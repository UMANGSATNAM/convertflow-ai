            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {categoryList.map((category) => (
                        <div
                            ...
                            className="section-preview group"
                        >
                            <div className="aspect-w-16 aspect-h-9 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                            ...
                            <div className="p-4 bg-white">
                                <div className="flex items-center justify-between">
                                    <span className="category-badge">{categories[category].length} variations</span>
                ...
                {categoryList.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="mt-1 text-sm text-gray-500">Sections will appear here once they are added to the library.</p>
                    </div>
                )}
            </div>
        </div>
